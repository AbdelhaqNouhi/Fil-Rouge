            ...
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className='flex'>
                    <button
                        onClick={() => active()}
                        type="button"
                        className="inline-flex md:hidden focus:ring-gray-200 dark:text-[#D4C7A0]"
                    ...
                    <ul className="flex flex-col justify-center items-center text-white-200 p-2 mt-4 bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-[#4E4A42] md:dark:bg-[#4E4A42]">
                        ...
                        {isLogged ? (
                            ...
                            <li onClick={() => Auth_modal()}>
                                <NavLink
                                    to={"/signIn"}
                                        className= "block py-3 px-4 cursor-pointer hover:scale-105 duration-300 bg-[#D4C7A0] text-white rounded-md">
                                    sign in
                                </NavLink>
                            </li>
                        )}
